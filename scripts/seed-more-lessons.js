...
Without vision, businesses drift aimlessly, reacting to circumstances rather than pursuing purpose. With vision, you can weather storms, make difficult decisions, and inspire others to join your mission.`,
    ...
    bibleVerses: [
      ...
      { book: 'Habakkuk', chapter: 2, verse: 2, text: 'Write the vision, and make it plain upon tables, that he may run that readeth it.' }
    ],
    practicalSteps: [
...
Patient entrepreneurs make better decisions because they're not desperate. They build stronger foundations because they're not rushing. They develop deeper relationships because they invest time in people.`,
    ...
    bibleVerses: [
      { book: 'James', chapter: 5, verse: 7, text: 'Be patient therefore, brethren, unto the coming of the Lord. Behold, the husbandman waiteth for the precious fruit of the earth, and hath long patience for it.' },
...
When you pursue excellence, you honor God, serve customers well, build reputation, and create sustainable success. Excellence attracts opportunities that shortcuts never will.`,
    ...
    bibleVerses: [
      ...
      { book: 'Daniel', chapter: 6, verse: 3, text: 'Then this Daniel was preferred above the presidents and princes, because an excellent spirit was in him.' }
    ],
    practicalSteps: [
...
Humility doesn't mean weakness or low self-esteem. It means accurate self-assessment, openness to feedback, and recognition that all success ultimately comes from God.`,
    ...
    bibleVerses: [
      { book: 'Proverbs', chapter: 18, verse: 12, text: 'Before destruction the heart of man is haughty, and before honour is humility.' },
      { book: 'Philippians', chapter: 2, verse: 7, text: 'But made himself of no reputation, and took upon him the form of a servant.' }
    ],
    practicalSteps: [
...
Diligence means following through on commitments, paying attention to details, and maintaining focus when others get distracted. Over time, diligence creates an insurmountable advantage.`,
    ...
    bibleVerses: [
      { book: 'Proverbs', chapter: 10, verse: 4, text: 'He becometh poor that dealeth with a slack hand: but the hand of the diligent maketh rich.' },
      { book: 'Proverbs', chapter: 6, verse: 6, text: 'Go to the ant, thou sluggard; consider her ways, and be wise.' }
    ],
    practicalSteps: [
...
Courageous entrepreneurs take calculated risks, have difficult conversations, make unpopular decisions when necessary, and stand for their values even when it costs them.`,
    ...
    bibleVerses: [
      ...
      { book: 'Esther', chapter: 4, verse: 16, text: 'And so will I go in unto the king, which is not according to the law: and if I perish, I perish.' }
    ],
    practicalSteps: [
...
Effective communication means speaking truth in love, listening actively, being clear and concise, and knowing when silence is the better choice.`,
    ...
    bibleVerses: [
      { book: 'Proverbs', chapter: 25, verse: 11, text: 'A word fitly spoken is like apples of gold in pictures of silver.' },
      { book: 'James', chapter: 3, verse: 5, text: 'Even so the tongue is a little member, and boasteth great things.' }
    ],
    practicalSteps: [
...
Adversity builds character, reveals weaknesses to address, creates empathy for others, and often redirects us toward better paths. The entrepreneurs who thrive are those who view challenges as teachers rather than tormentors.`,
    ...
    bibleVerses: [
      { book: '1 Peter', chapter: 1, verse: 7, text: 'That the trial of your faith, being much more precious than of gold that perisheth, though it be tried with fire, might be found unto praise and honour and glory.' },
...
Right priorities mean putting God first, family second, and business third. Paradoxically, this order often leads to greater business success because it provides the foundation of peace, support, and wisdom that sustainable success requires.`,
    ...
    bibleVerses: [
      ...
      { book: 'Mark', chapter: 8, verse: 36, text: 'For what shall it profit a man, if he shall gain the whole world, and lose his own soul?' }
    ],
    practicalSteps: [
...
Seeking mentorship is not weakness—it's wisdom. And as you grow, you have a responsibility to mentor others, creating a legacy that extends beyond your own achievements.`,
    ...
    bibleVerses: [
      ...
      { book: '2 Timothy', chapter: 2, verse: 2, text: 'And the things that thou hast heard of me among many witnesses, the same commit thou to faithful men, who shall be able to teach others also.' }
    ],
    practicalSteps: [
...
Ecclesiastes says there's nothing new under the sun, yet God does new things. The balance is maintaining eternal truths while finding fresh applications. Innovation without roots is just novelty; roots without innovation become irrelevance.`,
    ...
    bibleVerses: [
      { book: 'Mark', chapter: 2, verse: 22, text: 'And no man putteth new wine into old bottles: else the new wine doth burst the bottles, and the wine is spilled, and the bottles will be marred: but new wine must be put into new bottles.' },
      { book: 'Isaiah', chapter: 43, verse: 19, text: 'Behold, I will do a new thing; now it shall spring forth; shall ye not know it?' }
    ],
    practicalSteps: [
...
Contentment enables better decisions because you're not operating from desperation. It improves relationships because you're not constantly striving. It creates sustainability because you can enjoy the journey, not just the destination.`,
    ...
    bibleVerses: [
      ...
      { book: '1 Timothy', chapter: 6, verse: 6, text: 'But godliness with contentment is great gain.' }
    ],
    practicalSteps: [
...
Forgiveness doesn't mean trusting unwisely or accepting continued mistreatment. It means releasing the debt someone owes you and trusting God for justice. Forgiveness frees you to move forward without the weight of bitterness.`,
    ...
    bibleVerses: [
      ...
      { book: 'Genesis', chapter: 50, verse: 20, text: 'But as for you, ye thought evil against me; but God meant it unto good.' }
    ],
    practicalSteps: [
...
Every yes is a no to something else. Every hour spent on low-value activities is an hour not spent on high-value ones. Stewarding time well requires clarity of priorities, discipline of focus, and courage to say no.`,
    ...
    bibleVerses: [
      { book: 'Ephesians', chapter: 5, verse: 16, text: 'Redeeming the time, because the days are evil.' },
      { book: 'Psalm', chapter: 90, verse: 12, text: 'So teach us to number our days, that we may apply our hearts unto wisdom.' }
    ],
    practicalSteps: [
      ...
      'Regular evaluate if your time usage aligns with your priorities'
    ]
  },
...
Your legacy includes the people you develop, the culture you create, the customers you serve well, and the community you impact. What will people say about your business and leadership when you're gone?`,
    ...
    bibleVerses: [
      { book: 'Proverbs', chapter: 22, verse: 1, text: 'A good name is rather to be chosen than great riches, and loving favour rather than silver and gold.' },
      { book: 'Proverbs', chapter: 13, verse: 22, text: 'A good man leaveth an inheritance to his children\'s children.' }
    ],
    practicalSteps: [
...
Faith without works is presumption. Works without faith is pride. The sweet spot is working diligently while trusting completely—doing everything you can while acknowledging that results come from God.`,
    ...
    bibleVerses: [
      ...
      { book: 'Nehemiah', chapter: 4, verse: 9, text: 'Nevertheless we made our prayer unto our God, and set a watch against them day and night.' }
    ],
    practicalSteps: [
...
async function seedMoreLessons() {
  console.log('Starting to seed additional lessons...');
  ...
  await batch.commit();
  console.log(`\n✓ Successfully added ${additionalLessons.length} more lessons!`);
