  ...
  try {
    ...
    if (nodeEnv === 'production') {
      ...
      if (!fs.existsSync(keyPath)) {
        ...
        console.warn('\n   Server will start without Firebase. Only health check will be available.\n');
      } else {
    ...
    console.error('   Server will start without Firebase. Only health check will be available.\n');
  }
}

// Export Firebase services with safe fallbacks
module.exports = {
  admin,
